...
declare module 'bcoin' {
  ...
  namespace wallet {
    ...
    interface Details {
      ...
      toJSON(network?: NetworkType | Network);
    }
    ...
    export class TXDB {
      ...
      public addTXMap(b: DB | Bucket | Batch, hash: Buffer);
       ...
       * @param options
       */
      getRangeHashes(acct: number, options: RangeQueryOption);
    ...
    export class WalletDB {
      ...
      public addTXMap(b: DB | Bucket | Batch, hash: Buffer, wid: WID);
